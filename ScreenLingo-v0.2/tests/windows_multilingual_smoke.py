...
'''
for mode in sys.argv[1:] or ['en_wrapped','ja_horizontal','ja_vertical','ja_ruby','auto','zh_horizontal','auto_zh','auto_en','en_many']:
    ...
    if mode!='en_many': assert len(frame['lines'])==1,mode
    if mode=='en_many':
